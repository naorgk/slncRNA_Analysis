...
% uncomment the funcion handle you wish to run (constant, slope or burst)
...
[time_stat_pos,time_stat_neg,time_stat_var,time_between_pos,rate_pos,rate_neg,amp_pos,...
    amp_neg,amp_var,postPos,postNeg,postVar,numberOfEvents,...
    numberOfSignalWithEvents,eventsPerSignal] = ...
